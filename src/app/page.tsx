        ...
        <div className="container px-4 md:px-6 mx-auto relative z-10 flex flex-col items-center text-center">
          ...
          >
            {user ? (
              ...
              <Button size="lg" className="h-14 px-8 text-base gap-2 rounded-full shadow-lg hover:shadow-primary/25 transition-all duration-300">
                Start Mirroring <MoveRight className="w-5 h-5 ml-1" />
              </Button>
            )}
